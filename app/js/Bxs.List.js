...
Bxs.List = function(url,fieldName) {
...
Bxs.List.prototype = {
	...
	boot: function() {
		...
		Bxs.Ajax.getMetadata(self.fieldName,function(metadata) {
			
			self.metadata = metadata;
			
			Bxs.Ajax.get(Bxs.location.root+"/"+self.url,function(dataSet,notModified) {
